...
function serializePlayerData(toSerialize, options) {
    ...
    for (const [characterId, character] of Object.entries(toSerialize.characterList)) {
        ...
        const manaBoard = (_a = options === null || options === void 0 ? void 0 : options.manaBoardAwakeMap) === null || _a === void 0 ? void 0 : _a.get(characterId);
        if (manaBoard) {
    ...
    for (const [section, progresses] of Object.entries(toSerialize.questProgress)) {
        ...
        for (const progress of progresses) {
            list.push({
                ...
                "high_score": (_b = progress.highScore) !== null && _b !== void 0 ? _b : 0,
    ...
    if (tutorialStep !== null && toSerialize.triggeredTutorial.find((value) => value === 12) === undefined) {
        userTutorial = {
            "viewer_id": (_c = options === null || options === void 0 ? void 0 : options.viewerId) !== null && _c !== void 0 ? _c : 0,
    ...
    if ((_d = options === null || options === void 0 ? void 0 : options.serializeRushEventData) !== null && _d !== void 0 ? _d : false) {
        // rush event list
        ...
        if (toSerialize.rushEventPlayedPartyList !== undefined) {
            ...
            for (const [eventId, parties] of Object.entries(toSerialize.rushEventPlayedPartyList)) {
                ...
                for (const party of parties) {
                    ...
                    bucket[party.round] = (0, rushEvent_1.serializePlayerRushEventPlayedParty)(party);
                }
